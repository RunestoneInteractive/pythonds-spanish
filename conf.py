...
project = u'Solución de problemas con algoritmos y estructuras de datos'
...
html_theme_options = {
    ...
    #'navbar_title': "Solucion de problemas con algoritmos y estructuras de datos", #Estaba activa, yo la desctive para que saliera la tilde en la barra de navegacion
...
html_title = u'Solución de problemas con algoritmos y estructuras de datos'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'Solución de problemas con algoritmos y estructuras de datos'
